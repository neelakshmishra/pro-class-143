...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state={
      movieDetails: {},
      ngrok_url:"https://cff1-2401-4900-1c09-b01b-386b-eed0-f414-b553.ngrok-free.app"
    }
  }
  ...
  render() {
    if (this.state.movieDetails.poster_link){
      return (
          ...
          >
            ...
            <View style={styles.subContainer}>
              <View style={styles.posterContainer}>
                ...
                <Image style = {styles.posterImage} source={{uri: this.state.movieDetails.poster_link}}/>
              </View>
              <View style={{flex:0.15}}>
                {/*Add the components to show the movie name and other details ( release date & duration) below*/}
                 <View style={styles.detailsContainer}> 
                  ...
                  <Text style= {styles.subtitle}>{this.state.movieDetails.duration}</Text>
                 </View>
              </View>
              <View style={styles.ratingContainer}>
                {/*Add the components to show rating of the movie below*/}
                 <Star style = {styles.starStyle} score={this.state.movieDetails.rating}/>
              </View>
